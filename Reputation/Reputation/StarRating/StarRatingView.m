...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if (CGRectContainsPoint(self.bounds, [[[touches allObjects]lastObject] locationInView:self])) {
        ...
        float star = MIN(4,xpos/((self.bounds.size.width-kLabelAllowance-kLeftPadding)/5.0f));
...
-(void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    if (CGRectContainsPoint(self.bounds, [[[touches allObjects]lastObject] locationInView:self])) {
        ...
        int xpos = [[[touches allObjects]lastObject] locationInView:self].x - kLeftPadding;
